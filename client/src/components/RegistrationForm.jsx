...
const RegistrationForm = props => {
    ...
    return (
        ...
        <form onSubmit={ handleRegistration }>
            ...
            <input type='text' className="form-control" name='password'p placeholder="Password" onChange = {onChangeHandler}/>
            ...
            <input type='text' className="form-control" name='confirmPassword' placeholder="Re-enter Password" onChange = {onChangeHandler}/>
